...
char college[100] = "Rajarajeshwari College Of Engineering";
char dept[100] = "Department of Computer Science & Engineering";
char heading[100] = "Made by                                                                 Guides";
char row1[100] = "Shilpashree H A (1RR18CS130)                         Asst Prof. Mr. Manjunath S R";
char row2[100] = "                                                                                 ";
...
void frontscreen(void)
{
    ...
    glClearColor(0.45, 0.56, 0.8, 1.0);
    int s;
